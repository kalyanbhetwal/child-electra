...
def preprocess_owt_job(tokenizer, src_dir, tmp_dir, trg_dir, job_archives, n_tensors_per_file, max_seq_length, job_id=0):
    ...
    for archive_id, archive in enumerate(job_archives[job_id]):
        ...
        with open(src_dir / archive) as t:
            print(" the extracted archieve ", archive)
            extracted_archive = src_dir
...
class Args:
    src_dir: arg.Str = 'data/aochildies'
    trg_dir: arg.Str = 'data/aochildies_features'
